...
from envs import maze_env_utils, maze_task
from envs.agent_model import AgentModel
...
class MazeEnv(gym.Env):
    ...
    def reset(self, pos=0) -> np.ndarray:
        self.t = 0
        ...
        # else:
        xy = self._init_positions[pos] # the exact desired initial spot
        self.wrapped_env.set_xy(xy)
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, dict]:
        ...
        done = self._task.termination(next_obs) > 0
