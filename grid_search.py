...
lrs = [0.003, 0.03, 0.01]
updates = [100, 50, 30, 200]

for lr in lrs:
    for u in updates:
        job_file = os.path.join(job_directory, "grid_{}_{}.slurm".format(lr, u))
        ...
        with open(job_file, 'w') as fh:
            ...
            fh.writelines("#SBATCH --output=sac_{}_{}_%j.out\n".format(lr, u))
            fh.writelines("#SBATCH --error=sac_{}_{}_%j.out\n".format(lr, u))
            ...
            fh.writelines("srun python -u -B main.py --agent 'SAC' --lr {} --updates-per-step {} --save-dir 'experiments' 2>&1".format(lr, u))
